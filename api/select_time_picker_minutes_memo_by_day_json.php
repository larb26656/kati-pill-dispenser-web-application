...
include("../connect.php");
$hours=$_POST['hours'];
$dayofweek=get_day_of_week_num($_POST['dayofweek']);
...
echo json_encode(get_all_minute_list($hours,$dayofweek));
?>