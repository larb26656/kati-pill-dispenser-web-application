...
$(document).ready(function () {
 $('[data-toggle="tooltip"]').tooltip();   
  ...
  function select_pill_in_slot(slot_id){
      ...
      $.ajax({
      type:"POST",
      url:"include/slots/select_pill_in_slot.php",
      data: info,
  ...
  function select_pill(slot_id,pill_id)
{

 var info = 'slot_id=' + slot_id + '&pill_id=' + pill_id;

     swal({
  title: "คุณแน่ใจแล้วเหรือ",
  text: "ที่จะเปลี่ยนยาในช่องจ่ายยา?",
  type: "warning",
...
function(){
        var html = $.ajax({
        type: "GET",
        url: "include/slots/update_slot.php",
        data: info,
        async: false ,
         success: function() {
      ...
      ?>
       <div class="col-md-3">
              <div class="panel panel-default">
                ...
                <div class="panel-body dashboard_info"><?php echo $strBlankslot;?>
              </div>
            </div>
            </div>
      <?php
      ...
      ?>
       <div class="col-md-3">
              <div class="panel panel-default">
                ...
                <div class="panel-body dashboard_info"><span class="hover_able" data-toggle="tooltip" title="<?php echo $row2['Pill_commonname_'.$strEtclanglabel]; ?>"><b><?php echo  mb_substr($row2['Pill_commonname_'.$strEtclanglabel],0,60,'UTF-8');?></b></span><div class="pull-right"><button type="button" class="btn btn-default btn-xs open-detail-pill hover_able" data-target="#pill_detail" data-toggle="modal" onClick="select_slot_detail(<?= $row['Slot_num'] ?>)"><?php echo $strSlotdetail; ?></button>
              </div>
            </div>
            </div>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo $strDetailslottitle;?></h4>
        </div>
