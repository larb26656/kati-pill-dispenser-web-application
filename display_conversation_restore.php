...
<?php 
include("connect.php");
$sql = "SELECT * FROM `conversation` WHERE Conversation_visiblestatus = '0'";
...
<td>
<button type="button" class="btn btn-success btn-xs" onClick="restore_conversation(<?= $row['Conversation_id'] ?>)"><?php echo $strTablerecoverybutton;?></button>
</td>
      </tr>
     <?php } ?>
    </tbody>
